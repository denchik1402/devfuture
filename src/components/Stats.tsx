        ...
        <div className="mt-14 grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6">
          {STATS.map((stat, i) => (
            <Reveal key={stat.label} delay={i * 0.1}>
              <div className="glass group relative overflow-hidden rounded-2xl p-6 md:p-8">
                <div className="pointer-events-none absolute -right-8 -top-8 h-24 w-24 rounded-full bg-cyan-neon/10 blur-2xl opacity-50" />
                <Counter
                  value={stat.value}
                  suffix={stat.suffix}
